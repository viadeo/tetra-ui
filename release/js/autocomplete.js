/*! Tetra UI v1.0.15 | (MIT Licence) (c) Viadeo/APVO Corp - inspired by Bootstrap (c) Twitter, Inc. (Apache 2 Licence) */
    ...
    return {
      ...
      methods: {
        ...
        startCountDown: function(callback, data) {
          ...
          me.countDown = window.setTimeout(function() { callback(data); }, typingDelay);
        }
      }
    };
  }
