            ...
            events: {
                ...
                controller: {
                    "set state": function(data) {
                        var container = _("#" + data.id), checkbox = container.find("input");
                        data.state ? container.addClass("btn-toggle-checked") : container.removeClass("btn-toggle-checked"), 
                        checkbox.prop("checked", data.state), app.notify("toggle state changed", {
                            id: data.id,
                            state: data.state
                        });
                    },
                    "invert state": function(data) {
                        var container = _("#" + data.id), checkbox = container.find("input");
                        container.toggleClass("btn-toggle-checked"), checkbox.prop("checked", !checkbox.prop("checked")), 
