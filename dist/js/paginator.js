                ...
                user: {
                    click: {
                        ".paginator .paginator-btn": function(e, elm) {
                            var parent = elm.parents(".multi:first"), list = parent.find(".multi-list:first");
                            parent.addClass("open"), me.methods.show_multiPaginator(list);
                        },
                        ".paginator .multi .active > a": function(e, elm) {
                            var parent = elm.parents(".multi:first"), list = parent.find(".multi-list:first");
                            parent.removeClass("open"), me.methods.hide_multiPaginator(list);
                        }
                    },
                    clickout: {
                        ".paginator .paginator-btn": function(e, elm) {
